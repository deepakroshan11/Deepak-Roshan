...
import { getProjectBySlug } from "@/lib/projects-route";
    ...
    try {
                        ...
                        <div style={styles.middleWrapper}>
                            <div style={styles.wrapper}>
                                ...
                                <div style={styles.mainContainer}>
                                    <div style={styles.title}>Project not found</div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        const description =
            project.description.length > 220
                ? `${project.description.slice(0, 217)}…`
                : project.description;
                    ...
                    <div style={styles.middleWrapper}>
                        <div style={styles.wrapper}>
                            ...
                            <div style={styles.mainContainer}>
                                ...
                                <div style={styles.date}>{project.dates}</div>
                            </div>
                        </div>
                    </div>
                </div>
